...
class Parser:
    ...
    def __init__(self):
        self.g = Graphe() # Création d'une instance de graphe depuis graphe
        ...
        for ligne in lignes:
            ...
            if(ligne.strip() != ''):
                ...
                if "###" in ligne:
                    ...
                    for item in list_values:
                        if(item != '\n'):
                            if(counter == 1): #Numéro de ligne
                                line = item  
                                counter += 1

                            elif(counter == 2): #Sens du voyage
                                sens = item
                                counter += 1

                            elif(counter == 3): #Nom de la station
                                name = item
                            ...
                            elif(counter == 4): #Coord X
                                x = float(item)
                                counter += 1

                            elif(counter == 5): #Coord Y
                                y = float(item)
                                if (line =='funi'):
                            ...
                            elif(counter == 6): #Premier metro arret
                                first = item
                                counter += 1

                            elif(counter == 7): #Dernier metro arret
                                last = item
...
if __name__ == '__main__':
    ...
    p = Parser()
    p.parse() # Construction 
    p.calculArrete()
    #p.g.all_segment()
    p.g.stations[0].toString()
